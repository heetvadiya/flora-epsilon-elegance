      ...
      <div className="container mx-auto py-12 px-4 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Premium SPC flooring for luxury spaces. Engineered for beauty and
              performance.
            </p>
          ...
          <div>
            <h4 className="font-medium text-lg mb-4">More</h4>
            <ul className="space-y-2">
              {[
          ...
          <div>
            ...
            <div className="space-y-3 text-muted-foreground">
              <div className="flex items-start">
                ...
                <span>info@florabyepsilon.com</span>
              </div>
              <div className="flex items-start">
        ...
        <div className="border-t mt-12 pt-6 text-sm text-muted-foreground">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p>&copy; {new Date().getFullYear()} FLORA by Epsilon. All rights reserved.</p>
